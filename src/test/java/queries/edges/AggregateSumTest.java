...
class AggregateSumTest extends QueryBaseStaticTest {
    ...
    void asQueryGraph() throws Exception {
        ...
        assertEquals(30, execute(queryGraph).get("uses").property("likes"));
    }
    ...
    void asQbeTable() throws Exception {
        ...
        assertEquals(30, execute(query).get("uses").property("likes"));
    }
    ...
    void filterAndSumByProperty() throws Exception {
        ...
        assertEquals(10, execute(query).get("uses").property("likes"));
    }
